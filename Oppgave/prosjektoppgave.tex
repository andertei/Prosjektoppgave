...
\hline 
\end{tabular} 
\label{tab:tab:thermalIonisation}
\end{table}

\begin{figure}[H]
\centering
\includegraphics[scale=0.4]{Bilder/Theory/particleDensSF6.png}
...
\begin{figure}[H]
\centering
\includegraphics[scale=0.4]{Bilder/Theory/SF6Conduct.png}
\caption{Electrical conductivity of SF$_6$ at atmospheric pressure \cite{bib:HVEbreak}.} \label{fig:condSF6}
\end{figure}
