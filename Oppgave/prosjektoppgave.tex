...
As illustrated in figure \ref{fig:used_d4_d3_female} the tulip contact for both geometries have few signs of wear. Non of the tulip contacts were replaced during the experiment, but was polished half way trough each test series to remove soot and other pollution that may have formed on them. The surface area which an arc can burn on is larger for the tulip contact than the pin contact and might be the reason for the much higher durability in the tulip contact than the pin contact.
