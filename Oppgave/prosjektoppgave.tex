...
Even though the difference in thermal conductivity at high temperatures is a challenge when dealing with air instead of SF$_6$, it is the difference between the heat transport properties at lower temperatures that are the most challenging.
