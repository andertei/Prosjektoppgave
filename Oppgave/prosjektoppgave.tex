...
-increase the nozzle size so that the arc and wall effects becomes smaller

-nozzle with increasing diameter, so that the area behind the arc is considered bigger.
